...
def no_media_show_pointByhand(img, point1, point2, point3, grid_number, const_rate, width_rate, show_ori, whether_grid, lower_bound, upper_bound, hand_type):
    ...
    try:
        originx, originy, xEnd_x, xEnd_y = zuobiao(ori_img, detect)
    except:
            return 0
    print(originx, originy, xEnd_x, xEnd_y)

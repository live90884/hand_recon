...
def predict():
    ...
    if flask.request.method == "POST":
        ...
        try:
            show_point(cv2.cvtColor(np.array(img), cv2.COLOR_BGR2RGB), a, b, c, grid_number = 5, const_rate = 8, width_rate = 2, whether_grid = False, show_ori = True, whether_show = False, lower_bound = 30, upper_bound = 170)
